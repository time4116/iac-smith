...
def test_default_file_generator_uses_spec_renderer(monkeypatch):
    calls = []
...
def test_default_file_generator_uses_freeform_escape_hatch(monkeypatch):
    calls = []
    ...
    monkeypatch.setenv("IAC_SMITH_GENERATION_MODE", "freeform")
    monkeypatch.setattr(
